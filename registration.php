				...
				<article class="col-xs-12 maincontent">
					...
					<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
						<div class="panel panel-default">
							<div class="panel-body" id="container-tabs">
								<div id="tabbox">
									<a href="#" id="student" class="tab student-class">Student</a>
									<a href="#" id="mentor" class="tab select">Mentor</a>
								</div>

								<div id="form-panel">
									<!-- studentBox for student registration form -->
									<div id="studentBox">Student Registration</div>

									<!-- mentorBox for mentor registration form-->
									<div id="mentorBox">Mentor Registration</div>
								</div>
